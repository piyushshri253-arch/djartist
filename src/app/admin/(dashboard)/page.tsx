                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="sm:col-span-2">
                      <label className="text-xs font-bold text-slate-700 block mb-1">
                        Ticketing / Production Status
                      </label>
                      <select
                        value={eventForm.status}
                        onChange={(e) => setEventForm({ ...eventForm, status: e.target.value })}
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 text-xs font-bold focus:outline-none focus:border-amber-500 cursor-pointer"
                      >
                        <option value="SELLING FAST">SELLING FAST (Upcoming Tour)</option>
                        <option value="LIMITED PASSES">LIMITED PASSES (Upcoming Tour)</option>
                        <option value="SOLD OUT">SOLD OUT (Upcoming Tour)</option>
                        <option value="ANNOUNCED">ANNOUNCED (Upcoming Tour)</option>
                        <option value="COMPLETED">COMPLETED (Past Event Archive)</option>
                        <option value="ARCHIVED">ARCHIVED (Past Event Archive)</option>
                      </select>
                    </div>
                  </div>
