        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <tbody className="divide-y divide-white/5 text-[#F4F1EA]">
                    {[
                      ...
                      <tr key={row.num} className="hover:bg-white/5">
                        <td className="p-4 font-mono text-[#FF8400]">{row.num}</td>
                        <td className="p-4 font-bold text-white">{row.title}</td>
                        <td className="p-4 text-[#969696]">{row.artist}</td>
                        <td className="p-4 font-mono text-[#969696]">{row.bpm}</td>
                        <td className="p-4 font-mono text-[#969696]">{row.key}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="space-y-8">
            <div className="glass-card p-6 rounded-2xl border border-white/10">
              <span className="text-xs font-bold tracking-wider text-[#FF8400] uppercase block mb-3">
                Live Audio Stream
              </span>
              ...
              <button
                onClick={togglePlay}
                className="w-full py-3 rounded-full bg-gradient-to-r from-[#FF6A00] to-[#FF8400] text-black font-bold text-xs tracking-wider uppercase flex items-center justify-center gap-2 hover:shadow-spark transition-all"
              >
