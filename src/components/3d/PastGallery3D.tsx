    ...
    <group position={[0, 2.4, -170]}>
      ...
      <group position={[-3.6, 0, 0]} rotation={[0, 0.2, 0]}>
        <mesh>
          ...
          <meshStandardMaterial color="#0b0b0e" roughness={0.3} metalness={0.7} />
        </mesh>
        <mesh position={[0, 0, 0.06]}>
          <planeGeometry args={[3.6, 2.3]} />
          <meshStandardMaterial map={sunsetTexture} roughness={0.4} />
        </mesh>
        <Text position={[0, -1.45, 0]} fontSize={0.18} color="#FF8400" anchorX="center" letterSpacing={0.12}>
      ...
      <group position={[0, 0, -5]}>
        ...
        <spotLight position={[0, 3.5, 2]} intensity={3.0} angle={0.5} color="#FF8400" distance={9} />
      </group>
