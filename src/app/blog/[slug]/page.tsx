...
export default function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-[#F5F2EA] relative selection:bg-[#FF6A00] selection:text-black">
      {/* Top Scroll Progress Bar */}
      <div className="fixed top-0 left-0 right-0 h-[3px] bg-white/5 z-50">
        <div
          className="h-full bg-gradient-to-r from-[#FF6A00] via-[#FF8400] to-[#7A4CFF] shadow-[0_0_12px_rgba(255,106,0,0.8)] transition-all duration-100 ease-out"
          style={{ width: `${scrollProgress}%` }}
        />
      </div>

      {/* Atmospheric Ambient Glows */}
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-b from-[#FF6A00]/10 via-[#7A4CFF]/5 to-transparent blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="pt-28 sm:pt-36 pb-24 px-4 sm:px-6 lg:px-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8 pb-4 border-b border-white/10">
          <div className="flex items-center gap-2 text-xs font-mono text-[#969696]">
            ...
            <span>/</span>
            <span className="text-[#FF8400] truncate max-w-[200px] sm:max-w-none">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 hover:bg-[#FF6A00]/15 border border-white/10 hover:border-[#FF6A00]/50 text-xs font-bold text-[#FF8400] transition-all group"
          >
        ...
        <header className="max-w-4xl mx-auto text-center mb-12 sm:mb-16">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FF6A00]/10 border border-[#FF6A00]/30 backdrop-blur-md mb-6">
            <span className="w-2 h-2 rounded-full bg-[#FF6A00] animate-ping" />
            <span className="w-2 h-2 rounded-full bg-[#FF6A00] -ml-4" />
            <span className="text-xs font-bold tracking-[0.2em] text-[#FF8400] uppercase font-mono">
              {post.category}
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 py-5 px-6 rounded-2xl glass-card border border-white/10 backdrop-blur-xl max-w-3xl mx-auto text-xs">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#FF6A00] shadow-[0_0_12px_rgba(255,106,0,0.4)] flex-shrink-0">
                <img
              ...
              <div className="text-left">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="inline-flex items-center text-[10px] font-bold text-[#FF8400] bg-[#FF6A00]/20 px-1.5 py-0.5 rounded border border-[#FF6A00]/30 font-mono">
            ...
            {/* Date */}
            <div className="flex items-center gap-2 text-[#969696] font-mono">
          ...
          <div className="cinematic-viewfinder rounded-2xl overflow-hidden border border-white/15 bg-black/80 shadow-2xl relative group">
            <div className="relative aspect-[16/9] sm:aspect-[21/9] w-full overflow-hidden">
              ...
              <div className="absolute top-4 left-4 sm:top-6 sm:left-6 flex items-center gap-3">
                ...
                <span className="px-3 py-1 rounded-md bg-[#FF6A00]/20 backdrop-blur-md border border-[#FF6A00]/40 text-[10px] font-mono font-bold text-[#FF8400] tracking-widest uppercase hidden sm:inline-block">
                  24-BIT / 96KHZ FLAC
                </span>
              </div>
            </div>
            ...
            <div className="py-3 px-5 sm:px-8 bg-black/90 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono text-[#969696]">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
                <span>VISUAL TELEMETRY: 64-AXIS VOLUMETRIC LASER ARRAY // MAIN ARENA STAGE</span>
              </div>
              <div className="flex items-center gap-4 text-xs text-[#FF8400]">
        ...
        <div className="max-w-4xl mx-auto mb-12 flex flex-wrap items-center justify-between gap-4 p-4 rounded-2xl glass-card border border-white/10 backdrop-blur-xl">
          ...
          >
            <Flame className={`w-4 h-4 ${hasSparked ? "fill-black" : "text-[#FF6A00]"}`} />
          ...
          >
            {isCompanionPlaying ? (
              ...
              <Play className="w-4 h-4 text-[#FF8400] fill-[#FF8400]" />
            )}
            <div className="text-left">
              <span className="block text-[11px] font-mono tracking-wider text-[#FF8400]">
            ...
            <div className="flex items-end gap-0.5 h-4 ml-2">
              <span className={`w-1 bg-[#FF6A00] rounded-full transition-all ${isCompanionPlaying ? "h-4 animate-pulse" : "h-1"}`} />
              <span className={`w-1 bg-[#FF8400] rounded-full transition-all ${isCompanionPlaying ? "h-3 animate-bounce" : "h-1.5"}`} />
              <span className={`w-1 bg-[#7A4CFF] rounded-full transition-all ${isCompanionPlaying ? "h-4 animate-pulse" : "h-1"}`} />
              <span className={`w-1 bg-[#FF6A00] rounded-full transition-all ${isCompanionPlaying ? "h-2 animate-bounce" : "h-2"}`} />
            </div>
          </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-1 bg-black/40 p-1 rounded-xl border border-white/10 text-xs font-mono">
              <button
                ...
                className={`px-2 py-1 rounded ${fontSize === "normal" ? "bg-white/20 text-white font-bold" : "text-[#969696] hover:text-white"}`}
                title="Normal Text"
              >
                A
              </button>
              <button
                ...
                className={`px-2 py-1 rounded text-sm ${fontSize === "large" ? "bg-white/20 text-white font-bold" : "text-[#969696] hover:text-white"}`}
                title="Large Text"
              >
                A+
              </button>
              <button
                ...
                className={`px-2 py-1 rounded text-base ${fontSize === "xl" ? "bg-white/20 text-white font-bold" : "text-[#969696] hover:text-white"}`}
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white/5 hover:bg-green-500/20 text-[#969696] hover:text-green-400 border border-white/10 transition-colors"
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white/5 hover:bg-sky-500/20 text-[#969696] hover:text-sky-400 border border-white/10 transition-colors"
            ...
            <button
              ...
              className="relative p-2.5 rounded-xl bg-white/5 hover:bg-[#FF6A00]/20 text-[#969696] hover:text-[#FF8400] border border-white/10 transition-colors"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8">
            <article className={`text-[#d4d4dc] ${fontSizeClasses} space-y-8 font-sans`}>
              ...
              <div className="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-white/[0.04] to-transparent border border-white/10">
                <p className="text-xl sm:text-2xl text-white font-medium leading-relaxed first-letter:float-left first-letter:text-5xl sm:first-letter:text-6xl first-letter:font-black first-letter:text-[#FF8400] first-letter:mr-3 first-letter:leading-none">
                  {post.excerpt}
                </p>
              </div>
              ...
              {post.content ? (
                ...
                <>
                  ...
                  <blockquote className="my-8 p-6 sm:p-8 rounded-2xl bg-white/5 border-l-4 border-[#FF6A00] text-xl sm:text-2xl font-bold text-white italic shadow-lg">
                    ...
                    <span className="block text-xs font-mono font-normal text-[#FF8400] mt-3 not-italic">
              ...
              <div className="my-10 p-6 sm:p-8 rounded-2xl glass-card border border-white/10 bg-black/60 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#FF8400] uppercase tracking-wider mb-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                    <span className="block text-2xl font-black text-[#FF6A00] font-mono">100kW</span>
                    <span className="text-[11px] text-[#969696] uppercase font-mono mt-1 block">Continuous RMS</span>
                  </div>
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                    <span className="block text-2xl font-black text-white font-mono">28Hz</span>
                    <span className="text-[11px] text-[#969696] uppercase font-mono mt-1 block">Low Sub Extension</span>
                  </div>
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                    <span className="block text-2xl font-black text-[#7A4CFF] font-mono">32 CH</span>
                    <span className="text-[11px] text-[#969696] uppercase font-mono mt-1 block">DMX Laser Bridge</span>
                  </div>
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                    <span className="block text-2xl font-black text-green-400 font-mono">&lt;4ms</span>
                    <span className="text-[11px] text-[#969696] uppercase font-mono mt-1 block">Telemetry Latency</span>
                  </div>
                </div>
              </div>
              ...
              <div className="my-10 rounded-2xl overflow-hidden border border-white/10 bg-black">
                ...
                />
                <div className="p-4 bg-black/90 text-xs font-mono text-[#969696] flex items-center justify-between border-t border-white/10">
                  <span>PHOTO ARCHIVE // LIVE ARENA ENERGY & PYRO CHOREOGRAPHY</span>
                  <span className="text-[#FF8400]">NEW DELHI STADIUM</span>
                </div>
              </div>

              {/* Key Touring Takeaways Callout Box */}
              <div className="p-6 sm:p-8 rounded-2xl bg-[#0d0d12] border border-[#FF6A00]/25 relative">
                <div className="flex items-center gap-2 text-xs font-bold text-[#FF8400] uppercase tracking-wider font-mono mb-4">
              ...
              <div className="mt-12 p-8 rounded-2xl glass-card border border-white/10 flex flex-col sm:flex-row items-center sm:items-start gap-6 relative overflow-hidden">
                <div className="w-24 h-24 rounded-2xl overflow-hidden border-2 border-[#FF6A00] shadow-[0_0_20px_rgba(255,106,0,0.3)] flex-shrink-0">
                  <img
                    src="/images/dj_hero.jpg"
                    alt="DJ G SPARK"
                    className="w-full h-full object-cover"
                ...
                <div className="space-y-3 text-center sm:text-left flex-1">
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded-full bg-[#FF6A00]/20 border border-[#FF6A00]/40 text-[10px] font-bold text-[#FF8400] font-mono">
                      FOUNDER & HEADLINER
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-2">
                    <Link
                      href="/about"
                      className="text-xs font-bold text-[#FF8400] hover:text-white transition-colors"
                    >
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="p-6 rounded-2xl glass-card border border-[#FF6A00]/40 bg-gradient-to-b from-[#FF6A00]/10 via-[#0B0B0B] to-[#0B0B0B] relative overflow-hidden">
                <span className="text-[10px] font-mono font-bold tracking-widest text-[#FF8400] uppercase block mb-2">
                  2026 WORLD TOUR TICKETS & VIP
                </span>
                <h4 className="text-lg font-black text-white mb-2 leading-tight">
                  Experience The Stadium Show Live
                </h4>
                <p className="text-xs text-[#969696] leading-relaxed mb-5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-[#FF6A00] to-[#FF8400] hover:brightness-110 text-black font-extrabold text-xs tracking-wider uppercase text-center shadow-spark flex items-center justify-center gap-2 transition-all"
                >
                ...
                <div className="mt-3 text-center">
                  <span className="text-[10px] font-mono text-[#969696]">
              ...
              <div className="p-5 rounded-2xl glass-card border border-white/10 bg-black/60 space-y-4">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-mono text-[#FF8400] font-bold flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl overflow-hidden border border-white/15 relative flex-shrink-0">
                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                      <button
                        onClick={handleToggleCompanionAudio}
                        className="w-7 h-7 rounded-full bg-[#FF6A00] text-black flex items-center justify-center shadow-md hover:scale-110 transition-transform"
                      >
                        {isCompanionPlaying ? (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-[10px] font-mono text-[#969696] block truncate">
                      DJ G SPARK • 132 BPM
                    </span>
                  </div>
                </div>
              ...
              <div className="p-5 rounded-2xl glass-card border border-white/10 space-y-3">
                ...
                <nav className="space-y-2 text-xs font-medium">
                  <a
                    href="#introduction"
                    className="flex items-center gap-2 p-2 rounded-lg text-[#969696] hover:text-white hover:bg-white/5 transition-all"
                  >
                    <span className="font-mono text-[#FF8400] text-[10px]">01</span>
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 p-2 rounded-lg text-[#969696] hover:text-white hover:bg-white/5 transition-all"
                  >
                    <span className="font-mono text-[#FF8400] text-[10px]">02</span>
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 p-2 rounded-lg text-[#969696] hover:text-white hover:bg-white/5 transition-all"
                  >
                    <span className="font-mono text-[#FF8400] text-[10px]">03</span>
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 p-2 rounded-lg text-[#969696] hover:text-white hover:bg-white/5 transition-all"
                  >
                    <span className="font-mono text-[#FF8400] text-[10px]">04</span>
                    <span className="truncate">Key Touring Takeaways</span>
                  </a>
                  <a
                    href="#reviews"
                    className="flex items-center gap-2 p-2 rounded-lg text-[#FF8400] hover:text-white hover:bg-[#FF6A00]/10 transition-all font-semibold"
                  >
                    <span className="font-mono text-[#FF8400] text-[10px]">05</span>
                    <span className="truncate flex items-center gap-1.5">
                      <span>Reader Reviews</span>
                      <Star className="w-3 h-3 fill-[#FF8400]" />
                    </span>
                  </a>
                </nav>
              </div>
                ...
                <div className="space-y-3">
                  {relatedPosts.slice(0, 2).map((rel) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-[10px] font-mono text-[#FF8400] uppercase block">
                          {rel.category}
                        </span>
                        <h5 className="text-xs font-bold text-white truncate group-hover:text-[#FF8400] transition-colors">
                          {rel.title}
                        </h5>
        ...
        <div className="max-w-5xl mx-auto mt-20 pt-10 border-t border-white/10 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {prevPost && (
            <Link
              ...
              className="p-6 rounded-2xl glass-card border border-white/10 hover:border-[#FF6A00]/50 transition-all flex items-center gap-4 group"
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 text-[10px] font-mono text-[#969696] uppercase tracking-wider mb-1">
                  <ArrowLeft className="w-3 h-3 group-hover:-translate-x-1 transition-transform" />
                  <span>PREVIOUS DISPATCH</span>
                </div>
                <h4 className="text-sm font-bold text-white truncate group-hover:text-[#FF8400] transition-colors">
                  {prevPost.title}
                </h4>
                <span className="text-[11px] text-[#969696] font-mono mt-0.5 block">
          ...
          {nextPost && (
            <Link
              ...
              className="p-6 rounded-2xl glass-card border border-white/10 hover:border-[#FF6A00]/50 transition-all flex items-center justify-between gap-4 group text-right"
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-end gap-1.5 text-[10px] font-mono text-[#969696] uppercase tracking-wider mb-1">
        ...
        {relatedPosts.length > 0 && (
          <div className="max-w-5xl mx-auto mt-20">
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/10">
              <div>
                <span className="text-[11px] font-mono font-bold tracking-widest text-[#FF8400] uppercase block">
                  CONTINUE READING
                </span>
              ...
              <Link
                href="/blog"
                className="text-xs font-bold text-[#FF8400] hover:text-white transition-colors flex items-center gap-1 font-mono uppercase"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map((item) => (
                <article
                  key={item.id}
                  className="glass-card rounded-2xl overflow-hidden border border-white/10 hover:border-[#FF6A00]/40 transition-all flex flex-col justify-between group"
                >
                  <div className="relative h-44 w-full overflow-hidden bg-black/60">
                    ...
                    />
                    <span className="absolute top-3 left-3 px-2.5 py-0.5 rounded-full bg-black/80 backdrop-blur-md text-[9px] font-mono font-bold tracking-wider text-[#FF8400] uppercase border border-white/10">
                      {item.category}
                    </span>
                  </div>
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2 text-[10px] text-[#969696] font-mono mb-2">
                        <span>{item.dateDisplay}</span>
                        <span>•</span>
                        <span>{item.readTime}</span>
                      </div>

                      <h4 className="text-base font-bold text-white tracking-tight group-hover:text-[#FF8400] transition-colors line-clamp-2 mb-2">
                    ...
                    <div className="pt-3 border-t border-white/10 flex items-center justify-between text-xs">
                      ...
                      <Link
                        ...
                        className="text-[11px] font-bold text-[#FF8400] hover:text-white transition-colors flex items-center gap-1"
                      >
                        <span>Read</span>
        ...
        <div className="max-w-5xl mx-auto mt-20 p-8 sm:p-12 rounded-3xl relative overflow-hidden border border-[#FF6A00]/40 bg-gradient-to-r from-black via-[#0d0905] to-[#120a05] shadow-[0_0_60px_rgba(255,106,0,0.15)] text-center">
          <div className="absolute -top-24 -left-24 w-72 h-72 bg-[#FF6A00]/20 rounded-full blur-[90px] pointer-events-none" />
          <div className="absolute -bottom-24 -right-24 w-72 h-72 bg-[#7A4CFF]/20 rounded-full blur-[90px] pointer-events-none" />

          <span className="px-3.5 py-1 rounded-full bg-[#FF6A00]/20 border border-[#FF6A00]/40 text-xs font-mono font-bold text-[#FF8400] uppercase tracking-widest inline-block mb-4">
            LIVE ARENA EXPERIENCE
          </span>

          <h3 className="text-3xl sm:text-5xl font-black text-white tracking-tight mb-4">
            FEEL THE SPARK <span className="text-[#FF6A00]">LIVE IN CONCERT</span>
          </h3>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#FF6A00] to-[#FF8400] hover:brightness-110 text-black font-black text-sm tracking-wider uppercase shadow-spark flex items-center gap-2 transition-all"
            >
